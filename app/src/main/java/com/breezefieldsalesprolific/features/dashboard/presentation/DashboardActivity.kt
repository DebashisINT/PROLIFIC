package com.breezefieldsalesprolific.features.dashboard.presentation
...
import com.breezefieldsalesprolific.*
import com.breezefieldsalesprolific.R
import com.breezefieldsalesprolific.app.*
import com.breezefieldsalesprolific.app.NewFileUtils.browseDocuments
import com.breezefieldsalesprolific.app.NewFileUtils.browsePDFDocuments
import com.breezefieldsalesprolific.app.NewFileUtils.getExtension
import com.breezefieldsalesprolific.app.domain.*
import com.breezefieldsalesprolific.app.types.DashboardType
import com.breezefieldsalesprolific.app.types.FragType
import com.breezefieldsalesprolific.app.types.TopBarConfig
import com.breezefieldsalesprolific.app.uiaction.DisplayAlert
import com.breezefieldsalesprolific.app.utils.*
import com.breezefieldsalesprolific.app.utils.AppUtils.Companion.isProfile
import com.breezefieldsalesprolific.base.BaseResponse
import com.breezefieldsalesprolific.base.presentation.BaseActivity
import com.breezefieldsalesprolific.base.presentation.BaseFragment
import com.breezefieldsalesprolific.features.NewQuotation.*
import com.breezefieldsalesprolific.features.NewQuotation.api.GetQuotRegProvider
import com.breezefieldsalesprolific.features.NewQuotation.model.ViewDetailsQuotResponse
import com.breezefieldsalesprolific.features.SearchLocation.SearchLocationFragment
import com.breezefieldsalesprolific.features.SearchLocation.locationInfoModel
import com.breezefieldsalesprolific.features.TA.ViewAllTAListFragment
import com.breezefieldsalesprolific.features.achievement.AchievementFragment
import com.breezefieldsalesprolific.features.activities.presentation.*
import com.breezefieldsalesprolific.features.addAttendence.*
import com.breezefieldsalesprolific.features.addAttendence.api.addattendenceapi.AddAttendenceRepoProvider
import com.breezefieldsalesprolific.features.addAttendence.api.leavetytpeapi.LeaveTypeRepoProvider
import com.breezefieldsalesprolific.features.addAttendence.model.GetReportToFCMResponse
import com.breezefieldsalesprolific.features.addAttendence.model.GetReportToResponse
import com.breezefieldsalesprolific.features.addAttendence.model.Leave_list_Response
import com.breezefieldsalesprolific.features.addorder.presentation.AddOrderFragment
...
import com.breezefieldsalesprolific.features.addshop.presentation.AddShopFragment
import com.breezefieldsalesprolific.features.addshop.presentation.OTPVerificationDialog
import com.breezefieldsalesprolific.features.addshop.presentation.ScanImageFragment
import com.breezefieldsalesprolific.features.addshop.presentation.ShowCardDetailsDialog
import com.breezefieldsalesprolific.features.alarm.model.AlarmData
import com.breezefieldsalesprolific.features.alarm.presetation.AttendanceReportFragment
import com.breezefieldsalesprolific.features.alarm.presetation.PerformanceReportFragment
import com.breezefieldsalesprolific.features.alarm.presetation.VisitReportDetailsFragment
import com.breezefieldsalesprolific.features.alarm.presetation.VisitReportFragment
import com.breezefieldsalesprolific.features.attendance.AttendanceFragment
import com.breezefieldsalesprolific.features.attendance.api.AttendanceRepositoryProvider
import com.breezefieldsalesprolific.features.attendance.model.AttendanceRequest
import com.breezefieldsalesprolific.features.attendance.model.AttendanceResponse
import com.breezefieldsalesprolific.features.averageshop.presentation.AverageShopFragment
import com.breezefieldsalesprolific.features.avgorder.presentation.AverageOrderFragment
import com.breezefieldsalesprolific.features.avgtimespent.presentation.AvgTimespentShopListFragment
import com.breezefieldsalesprolific.features.beatCustom.TeamBeatListFragment
import com.breezefieldsalesprolific.features.billing.presentation.AddBillingFragment
import com.breezefieldsalesprolific.features.billing.presentation.BillingDetailsFragment
import com.breezefieldsalesprolific.features.billing.presentation.BillingListFragment
import com.breezefieldsalesprolific.features.changepassword.presentation.ChangePasswordDialog
import com.breezefieldsalesprolific.features.chat.model.ChatListDataModel
import com.breezefieldsalesprolific.features.chat.model.ChatUserDataModel
import com.breezefieldsalesprolific.features.chat.model.GroupUserDataModel
import com.breezefieldsalesprolific.features.chat.presentation.*
import com.breezefieldsalesprolific.features.chatbot.presentation.ChatBotFragment
import com.breezefieldsalesprolific.features.chatbot.presentation.ChatBotShopListFragment
import com.breezefieldsalesprolific.features.chatbot.presentation.ReportsFragment
import com.breezefieldsalesprolific.features.chatbot.presentation.SelectLanguageDialog
import com.breezefieldsalesprolific.features.commondialog.presentation.CommonDialog
import com.breezefieldsalesprolific.features.commondialog.presentation.CommonDialogClickListener
import com.breezefieldsalesprolific.features.commondialogsinglebtn.AddFeedbackSingleBtnDialog
import com.breezefieldsalesprolific.features.commondialogsinglebtn.CommonDialogSingleBtn
import com.breezefieldsalesprolific.features.commondialogsinglebtn.OnDialogClickListener
import com.breezefieldsalesprolific.features.commondialogsinglebtn.TermsAndConditionsSingleBtnDialog
import com.breezefieldsalesprolific.features.contacts.ActivityDtlsFrag
import com.breezefieldsalesprolific.features.contacts.AddOpptFrag
import com.breezefieldsalesprolific.features.contacts.ContactDtls
import com.breezefieldsalesprolific.features.contacts.ContactGr
import com.breezefieldsalesprolific.features.contacts.ContactsAddFrag
import com.breezefieldsalesprolific.features.contacts.ContactsFrag
import com.breezefieldsalesprolific.features.contacts.SchedulerAddFormFrag
import com.breezefieldsalesprolific.features.contacts.SchedulerViewFrag
import com.breezefieldsalesprolific.features.contacts.TemplateAddFrag
import com.breezefieldsalesprolific.features.contacts.TemplateViewFrag
import com.breezefieldsalesprolific.features.contacts.ViewCrmOpptFrag
import com.breezefieldsalesprolific.features.dailyPlan.prsentation.AllShopListFragment
import com.breezefieldsalesprolific.features.dailyPlan.prsentation.DailyPlanListFragment
import com.breezefieldsalesprolific.features.dailyPlan.prsentation.PlanDetailsFragment
import com.breezefieldsalesprolific.features.damageProduct.ShopDamageProductListFrag
import com.breezefieldsalesprolific.features.damageProduct.ShopDamageProductSubmitFrag
import com.breezefieldsalesprolific.features.dashboard.presentation.api.ShopVisitImageUploadRepoProvider
import com.breezefieldsalesprolific.features.dashboard.presentation.api.dashboardApi.DashboardRepoProvider
import com.breezefieldsalesprolific.features.dashboard.presentation.api.otpsentapi.OtpSentRepoProvider
import com.breezefieldsalesprolific.features.dashboard.presentation.api.otpverifyapi.OtpVerificationRepoProvider
import com.breezefieldsalesprolific.features.dashboard.presentation.api.unreadnotificationapi.UnreadNotificationRepoProvider
import com.breezefieldsalesprolific.features.dashboard.presentation.getcontentlisapi.GetContentListRepoProvider
import com.breezefieldsalesprolific.features.dashboard.presentation.model.ContentListResponseModel
import com.breezefieldsalesprolific.features.dashboard.presentation.model.ShopVisitImageUploadInputModel
import com.breezefieldsalesprolific.features.dashboard.presentation.model.UnreadNotificationResponseModel
import com.breezefieldsalesprolific.features.device_info.presentation.DeviceInfoListFragment
import com.breezefieldsalesprolific.features.distributorwiseorder.DistributorwiseorderlistFragment
import com.breezefieldsalesprolific.features.document.DocumentRepoFeatureNewFragment
import com.breezefieldsalesprolific.features.document.presentation.DocumentListFragment
import com.breezefieldsalesprolific.features.document.presentation.DocumentTypeListFragment
import com.breezefieldsalesprolific.features.document.presentation.OpenFileWebViewFragment
import com.breezefieldsalesprolific.features.dymanicSection.presentation.AddDynamicFragment
import com.breezefieldsalesprolific.features.dymanicSection.presentation.AllDynamicListFragment
import com.breezefieldsalesprolific.features.dymanicSection.presentation.DynamicListFragment
import com.breezefieldsalesprolific.features.dymanicSection.presentation.EditDynamicFragment
import com.breezefieldsalesprolific.features.gpsDisabilityScreen.GpsDisableFragment
import com.breezefieldsalesprolific.features.home.presentation.HomeFragment
import com.breezefieldsalesprolific.features.homelocation.presentation.HomeLocationFragment
import com.breezefieldsalesprolific.features.homelocation.presentation.HomeLocationMapFragment
import com.breezefieldsalesprolific.features.know_your_state.KnowYourStateFragment
import com.breezefieldsalesprolific.features.lead.LeadFrag
import com.breezefieldsalesprolific.features.lead.ViewLeadFrag
import com.breezefieldsalesprolific.features.leaderboard.LeaderBoardFrag
import com.breezefieldsalesprolific.features.leaveapplynew.LeaveHome
import com.breezefieldsalesprolific.features.leaveapplynew.model.clearAttendanceonRejectReqModelRejectReqModel
import com.breezefieldsalesprolific.features.localshops.LocalShopListFragment
import com.breezefieldsalesprolific.features.localshops.LocalShopListMapFragment
import com.breezefieldsalesprolific.features.localshops.NearByShopsMapFragment
import com.breezefieldsalesprolific.features.location.*
import com.breezefieldsalesprolific.features.location.api.LocationRepoProvider
import com.breezefieldsalesprolific.features.location.model.*
import com.breezefieldsalesprolific.features.location.shopRevisitStatus.ShopRevisitStatusRepositoryProvider
import com.breezefieldsalesprolific.features.location.shopdurationapi.ShopDurationRepositoryProvider
import com.breezefieldsalesprolific.features.login.ShopFeedbackEntity
import com.breezefieldsalesprolific.features.login.model.alarmconfigmodel.AlarmConfigDataModel
import com.breezefieldsalesprolific.features.login.presentation.LoginActivity
import com.breezefieldsalesprolific.features.logout.presentation.api.LogoutRepositoryProvider
import com.breezefieldsalesprolific.features.logoutsync.presentation.LogoutSyncFragment
import com.breezefieldsalesprolific.features.marketAssist.MarketAssistTabFrag
import com.breezefieldsalesprolific.features.marketAssist.ShopDtlsMarketAssistFrag
import com.breezefieldsalesprolific.features.marketAssist.ShopListMarketAssistFrag
import com.breezefieldsalesprolific.features.marketing.presentation.MarketingPagerFragment
import com.breezefieldsalesprolific.features.meetinglist.prsentation.MeetingListFragment
import com.breezefieldsalesprolific.features.member.MapViewForTeamFrag
import com.breezefieldsalesprolific.features.member.model.TeamLocDataModel
import com.breezefieldsalesprolific.features.member.model.TeamShopListDataModel
import com.breezefieldsalesprolific.features.member.presentation.*
import com.breezefieldsalesprolific.features.menuBeat.MenuBeatFrag
import com.breezefieldsalesprolific.features.micro_learning.presentation.FileOpeningTimeIntentService
import com.breezefieldsalesprolific.features.micro_learning.presentation.MicroLearningListFragment
import com.breezefieldsalesprolific.features.micro_learning.presentation.MicroLearningWebViewFragment
import com.breezefieldsalesprolific.features.myallowancerequest.MyallowanceRequestFragment
import com.breezefieldsalesprolific.features.myjobs.model.CustomerDataModel
import com.breezefieldsalesprolific.features.myjobs.presentation.*
import com.breezefieldsalesprolific.features.mylearning.MyLearningFragment
import com.breezefieldsalesprolific.features.myorder.presentation.MyOrderListFragment
import com.breezefieldsalesprolific.features.myprofile.presentation.MyProfileFragment
import com.breezefieldsalesprolific.features.nearbyshops.api.ShopListRepositoryProvider
import com.breezefieldsalesprolific.features.nearbyshops.model.ShopData
import com.breezefieldsalesprolific.features.nearbyshops.model.ShopListResponse
import com.breezefieldsalesprolific.features.nearbyshops.multipleattachImage.MultipleImageFragment
import com.breezefieldsalesprolific.features.nearbyshops.presentation.BeatListFragment
import com.breezefieldsalesprolific.features.nearbyshops.presentation.NearByShopsListFragment
import com.breezefieldsalesprolific.features.nearbyshops.presentation.NewNearByShopsListFragment
import com.breezefieldsalesprolific.features.nearbyshops.presentation.ShopCallHisFrag
import com.breezefieldsalesprolific.features.nearbyuserlist.presentation.NearbyUserListFragment
import com.breezefieldsalesprolific.features.newcollection.CollectionDetailsStatusFragment
import com.breezefieldsalesprolific.features.newcollection.CollectionShopListFragment
import com.breezefieldsalesprolific.features.newcollection.NewCollectionListFragment
import com.breezefieldsalesprolific.features.newcollectionreport.*
import com.breezefieldsalesprolific.features.notification.NotificationFragment
import com.breezefieldsalesprolific.features.orderITC.CartListFrag
import com.breezefieldsalesprolific.features.orderITC.OrderListFrag
import com.breezefieldsalesprolific.features.orderITC.ProductListFrag
import com.breezefieldsalesprolific.features.orderITC.ViewNewOrdHisAllFrag
import com.breezefieldsalesprolific.features.orderITC.ViewNewOrdHistoryFrag
import com.breezefieldsalesprolific.features.orderITC.ViewOrdDtls
import com.breezefieldsalesprolific.features.orderList.NewDateWiseOrderListFragment
import com.breezefieldsalesprolific.features.orderList.NewOrderListFragment
import com.breezefieldsalesprolific.features.orderList.OrderListFragment
import com.breezefieldsalesprolific.features.orderdetail.presentation.OrderDetailFragment
import com.breezefieldsalesprolific.features.orderhistory.ActivityMapFragment
import com.breezefieldsalesprolific.features.orderhistory.OrderhistoryFragment
import com.breezefieldsalesprolific.features.orderhistory.TimeLineFragment
import com.breezefieldsalesprolific.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
...
import com.breezefieldsalesprolific.features.orderhistory.model.LocationData
import com.breezefieldsalesprolific.features.pendinglocationinout.PendingOutLocationFrag
import com.breezefieldsalesprolific.features.performance.GpsStatusFragment
import com.breezefieldsalesprolific.features.performance.PerformanceFragment
import com.breezefieldsalesprolific.features.performance.api.UpdateGpsStatusRepoProvider
import com.breezefieldsalesprolific.features.performance.model.UpdateGpsInputParamsModel
import com.breezefieldsalesprolific.features.performanceAPP.OwnPerformanceFragment
import com.breezefieldsalesprolific.features.performanceAPP.PerformanceAppFragment
import com.breezefieldsalesprolific.features.performanceAPP.allPerformanceFrag
import com.breezefieldsalesprolific.features.permissionList.ViewPermissionFragment
import com.breezefieldsalesprolific.features.photoReg.*
import com.breezefieldsalesprolific.features.privacypolicy.PrivacypolicyWebviewFrag
import com.breezefieldsalesprolific.features.quotation.presentation.*
import com.breezefieldsalesprolific.features.reimbursement.presentation.*
import com.breezefieldsalesprolific.features.report.presentation.*
import com.breezefieldsalesprolific.features.returnsOrder.*
import com.breezefieldsalesprolific.features.settings.presentation.SettingsFragment
import com.breezefieldsalesprolific.features.shopFeedbackHistory.ShopFeedbackHisFrag
import com.breezefieldsalesprolific.features.shopdetail.presentation.*
import com.breezefieldsalesprolific.features.shopdetail.presentation.api.EditShopRepoProvider
import com.breezefieldsalesprolific.features.stock.StockDetailsFragment
import com.breezefieldsalesprolific.features.stock.StockListFragment
import com.breezefieldsalesprolific.features.stockAddCurrentStock.AddShopStockFragment
import com.breezefieldsalesprolific.features.stockAddCurrentStock.UpdateShopStockFragment
import com.breezefieldsalesprolific.features.stockAddCurrentStock.ViewStockDetailsFragment
import com.breezefieldsalesprolific.features.stockAddCurrentStock.model.MultipleImageFileUploadonStock
import com.breezefieldsalesprolific.features.stockCompetetorStock.AddCompetetorStockFragment
import com.breezefieldsalesprolific.features.stockCompetetorStock.CompetetorStockFragment
import com.breezefieldsalesprolific.features.stockCompetetorStock.ViewComStockProductDetails
import com.breezefieldsalesprolific.features.survey.SurveyFrag
import com.breezefieldsalesprolific.features.survey.SurveyViewDtlsFrag
import com.breezefieldsalesprolific.features.survey.SurveyViewFrag
import com.breezefieldsalesprolific.features.task.presentation.AddTaskFragment
import com.breezefieldsalesprolific.features.task.presentation.CalenderTaskFragment
import com.breezefieldsalesprolific.features.task.presentation.EditTaskFragment
import com.breezefieldsalesprolific.features.task.presentation.TaskListFragment
import com.breezefieldsalesprolific.features.taskManagement.TaskManagementFrag
import com.breezefieldsalesprolific.features.taskManagement.ViewTaskManagementFrag
import com.breezefieldsalesprolific.features.timesheet.presentation.AddTimeSheetFragment
import com.breezefieldsalesprolific.features.timesheet.presentation.EditTimeSheetFragment
import com.breezefieldsalesprolific.features.timesheet.presentation.TimeSheetListFragment
import com.breezefieldsalesprolific.features.viewAllOrder.CartFragment
import com.breezefieldsalesprolific.features.viewAllOrder.OrderTypeListFragment
import com.breezefieldsalesprolific.features.viewAllOrder.ViewAllOrderListFragment
import com.breezefieldsalesprolific.features.viewAllOrder.ViewCartFragment
import com.breezefieldsalesprolific.features.viewAllOrder.orderNew.NewOdrScrListFragment
import com.breezefieldsalesprolific.features.viewAllOrder.orderNew.NewOrderScrActiFragment
import com.breezefieldsalesprolific.features.viewAllOrder.orderNew.NewOrderScrOrderDetailsFragment
import com.breezefieldsalesprolific.features.viewAllOrder.orderNew.NeworderScrCartFragment
import com.breezefieldsalesprolific.features.viewAllOrder.orderOptimized.OrderProductCartFrag
import com.breezefieldsalesprolific.features.viewAllOrder.orderOptimized.OrderProductListFrag
import com.breezefieldsalesprolific.features.viewPPDDStock.ViewOutstandingFragment
import com.breezefieldsalesprolific.features.viewPPDDStock.ViewPPDDListFragment
import com.breezefieldsalesprolific.features.viewPPDDStock.ViewPPDDListOutstandingFragment
import com.breezefieldsalesprolific.features.viewPPDDStock.ViewStockFragment
import com.breezefieldsalesprolific.features.weather.presentation.WeatherFragment
import com.breezefieldsalesprolific.mappackage.MapActivity
import com.breezefieldsalesprolific.mappackage.MapActivityWithoutPath
import com.breezefieldsalesprolific.mappackage.SendBrod
import com.breezefieldsalesprolific.widgets.AppCustomEditText
import com.breezefieldsalesprolific.widgets.AppCustomTextView
...
import com.breezefieldsalesprolific.features.addshop.model.AudioFetchDataCLass
import com.breezefieldsalesprolific.features.login.api.opportunity.OpportunityRepoProvider
import com.breezefieldsalesprolific.features.login.model.NewSettingsResponseModel
import com.breezefieldsalesprolific.features.mylearning.AllTopicsWiseContents
import com.breezefieldsalesprolific.features.mylearning.BookmarkFetchResponse
import com.breezefieldsalesprolific.features.mylearning.BookmarkFrag
import com.breezefieldsalesprolific.features.mylearning.BookmarkPlayFrag
import com.breezefieldsalesprolific.features.mylearning.KnowledgeHubAllVideoList
import com.breezefieldsalesprolific.features.mylearning.LeaderboardLmsFrag
import com.breezefieldsalesprolific.features.mylearning.LmsQuestionAnswerSet
import com.breezefieldsalesprolific.features.mylearning.MyLearningAllVideoList
import com.breezefieldsalesprolific.features.mylearning.MyLearningTopicList
import com.breezefieldsalesprolific.features.mylearning.MyLearningVideoPlay
import com.breezefieldsalesprolific.features.mylearning.MyPerformanceFrag
import com.breezefieldsalesprolific.features.mylearning.MyTopicsWiseContents
import com.breezefieldsalesprolific.features.mylearning.NotificationLMSFragment
import com.breezefieldsalesprolific.features.mylearning.SearchLmsFrag
import com.breezefieldsalesprolific.features.mylearning.SearchLmsKnowledgeFrag
import com.breezefieldsalesprolific.features.mylearning.SearchLmsLearningFrag
import com.breezefieldsalesprolific.features.mylearning.VideoPlayLMS
import com.breezefieldsalesprolific.features.mylearning.apiCall.LMSRepoProvider
...
// val phototUri = Uri.parse(localAbsoluteFilePath)
            //val fileUrl = Uri.parse(File(Environment.getExternalStorageDirectory(), "xbreezefieldsalesprolificlogsample/log").path);
            //27-09-2021
// val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldsalesprolificlogsample/log").path);
...
// BuildConfig.APPLICATION_ID+"/Log/Fsmlog.html").path);
            var currentDBPath = "/data/user/0/com.breezefieldsalesprolific/files/Fsmlog.html"
        ...
        try {
            ...
            val fileUrl1 = Uri.parse(
                File(
                    ...
                    "xbreezefieldsalesprolificlogsample/log"
                ).path
            );
            val fileUrl2 = Uri.parse(
                File(
                    Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS),
                    "xbreezefieldsalesprolificlogsample/log.bak.1"
                ).path
            );
...
// return super.onCreateOptionsMenu(menu)
    ...
    fun generateNoteOnSD(context: Context?, sFileName: String?, sBody: String?) {
        try {
            val root = File(
                Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS),
                "xbreezefieldsalesprolificlogsample/log" + ".txt"
            )
            if (!root.exists()) {
                root.mkdirs()
            }
