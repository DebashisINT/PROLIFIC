...
import com.breezefieldsalesprolific.features.contacts.CustomDataLms
...
class MyPerformanceFrag : BaseFragment(), View.OnClickListener {
    ...
    private fun initview(view: View) {
        ...
        //iv_lms_performance.setColorFilter(ContextCompat.getColor(mContext, R.color.toolbar_lms), android.graphics.PorterDuff.Mode.MULTIPLY)
