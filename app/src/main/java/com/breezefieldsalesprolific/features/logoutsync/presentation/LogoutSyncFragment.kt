package com.breezefieldsalesprolific.features.logoutsync.presentation
...
import com.breezefieldsalesprolific.app.AppDatabase
...
import com.breezefieldsalesprolific.app.utils.AppUtils
import com.breezefieldsalesprolific.app.utils.Toaster
import com.breezefieldsalesprolific.base.BaseResponse
import com.breezefieldsalesprolific.base.presentation.BaseActivity
import com.breezefieldsalesprolific.base.presentation.BaseActivity.Companion.compositeDisposable
...
import com.breezefieldsalesprolific.features.billing.api.AddBillingRepoProvider
import com.breezefieldsalesprolific.features.billing.model.AddBillingInputParamsModel
...
import com.breezefieldsalesprolific.features.dashboard.presentation.ReasonDialog
...
import com.breezefieldsalesprolific.features.document.model.AddEditDocumentInputParams
import com.breezefieldsalesprolific.features.document.model.DocumentAttachmentModel
...
import com.breezefieldsalesprolific.features.nearbyshops.api.updateaddress.ShopAddressUpdateRepoProvider
...
import com.breezefieldsalesprolific.features.orderhistory.api.LocationUpdateRepositoryProviders
import com.breezefieldsalesprolific.features.orderhistory.model.*
...
import com.breezefieldsalesprolific.features.quotation.model.AddQuotInputModel
import com.breezefieldsalesprolific.features.shopdetail.presentation.api.EditShopRepoProvider
import com.breezefieldsalesprolific.features.shopdetail.presentation.api.addcollection.AddCollectionRepoProvider
import com.breezefieldsalesprolific.features.shopdetail.presentation.model.addcollection.AddCollectionInputParamsModel
...
import com.breezefieldsalesprolific.features.stockAddCurrentStock.ShopAddCurrentStockList
...
import com.breezefieldsalesprolific.features.timesheet.model.AddTimeSheetInputModel
import com.breezefieldsalesprolific.features.viewAllOrder.api.addorder.AddOrderRepoProvider
import com.breezefieldsalesprolific.features.viewAllOrder.model.AddOrderInputParamsModel
import com.breezefieldsalesprolific.features.viewAllOrder.model.AddOrderInputProductList
import com.breezefieldsalesprolific.mappackage.SendBrod
import com.breezefieldsalesprolific.widgets.AppCustomTextView
import com.breezefieldsalesprolific.MonitorService
import com.breezefieldsalesprolific.MySingleton
import com.breezefieldsalesprolific.app.AlarmReceiver
...
import com.breezefieldsalesprolific.features.addshop.presentation.ShopExtraContactReq
...
import com.breezefieldsalesprolific.features.dashboard.presentation.model.AudioSyncModel
...
import com.breezefieldsalesprolific.features.login.model.GetConcurrentUserResponse
import com.breezefieldsalesprolific.features.login.model.WhatsappApiData
import com.breezefieldsalesprolific.features.orderITC.SyncDeleteOppt
import com.breezefieldsalesprolific.features.orderITC.SyncDeleteOpptL
import com.breezefieldsalesprolific.features.orderITC.SyncEditOppt
import com.breezefieldsalesprolific.features.orderITC.SyncOppt
import com.breezefieldsalesprolific.features.orderITC.SyncOpptProductL
import com.breezefieldsalesprolific.features.orderITC.SyncOrd
import com.breezefieldsalesprolific.features.orderITC.SyncOrdProductL
import com.breezefieldsalesprolific.features.performance.model.Gps_status_list
import com.breezefieldsalesprolific.features.performance.model.UpdateGpsInputListParamsModel
import com.breezefieldsalesprolific.features.returnsOrder.ReturnProductList
import com.breezefieldsalesprolific.features.returnsOrder.ReturnRequest
import com.breezefieldsalesprolific.features.viewAllOrder.model.NewOrderSaveApiModel
...
//            checkToCallActivity()
    ...
    private fun callLogshareApi(){
        ...
        if(Pref.LogoutWithLogFile){
            try{
                val filesForZip: Array<String> = arrayOf(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldsalesprolificlogsample/log").path)
                ZipOutputStream(BufferedOutputStream(FileOutputStream(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldsalesprolificlogsample/log.zip").path))).use { out ->
                ...
                val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldsalesprolificlogsample/log.zip").path);
